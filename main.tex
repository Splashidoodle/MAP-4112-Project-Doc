...
81, 154, 373. The use of PCA improved accuracy and grew with an increasing
number of k principal components. Being able to retain most of the information
using components makes operations faster with relatively small k values.
\begin{figure}[h]
    \centering
    \hspace{-5cm}
    \begin{minipage}{\textwidth}
        \centering
        \includegraphics[width=1.5\linewidth]{confusion_matrix.png}
